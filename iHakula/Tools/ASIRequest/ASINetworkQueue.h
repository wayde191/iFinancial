...
@property (nonatomic, weak,setter=setUploadProgressDelegate:) id uploadProgressDelegate;
@property (nonatomic, weak,setter=setDownloadProgressDelegate:) id downloadProgressDelegate;
