...
@interface ASIHTTPRequest : NSOperation <NSCopying> {
	...
	id <ASIHTTPRequestDelegate> __weak delegate;
	...
	id <ASIHTTPRequestDelegate, ASIProgressDelegate> __weak queue;
	...
	id <ASIProgressDelegate> __weak uploadProgressDelegate;
	...
	id <ASIProgressDelegate> __weak downloadProgressDelegate;
	...
	ASIHTTPRequest __weak *mainRequest;
